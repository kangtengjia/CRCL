...
def parse_opt():
    ...
    parser.add_argument('--data_root', default='', help='RoMa data directory containing json/jsonl and DGCNN arrays.')
    parser.add_argument('--text_enc_type', choices=['bigru', 'bert'], default='bigru')
    parser.add_argument('--bert_path', default='', help='Local bert-base-uncased directory for BERT runs.')
    ...
    parser.add_argument('--num_epochs', default=30, type=int,
                        help='Total RoMa training epochs distributed across four CRCL phases.')
    ...
    parser.add_argument('--bert_learning_rate', default=3e-5, type=float,
                        help='Initial learning rate for the pretrained BERT encoder.')
    parser.add_argument('--bert_weight_decay', default=1e-2, type=float,
                        help='Weight decay applied to BERT parameters when using AdamW.')
    parser.add_argument('--bert_warmup_steps', default=0, type=int,
                        help='Linear BERT warmup steps; 0 selects 10% of total training steps.')
    ...
    parser.add_argument('--num_regions', default=36, type=int,
                        help='Number of precomputed visual regions or point-cloud patches.')
